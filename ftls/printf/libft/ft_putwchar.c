...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/06 23:48:15 by angonyam          #+#    #+#             */
/*   Updated: 2017/10/06 23:49:29 by angonyam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	wchar_u(wchar_t wc, char *convertion)
{
	int		len;
